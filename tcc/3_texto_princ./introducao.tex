...
A quarta e ultima etapa deve associa membros da tripulação com jornadas, de modo que cada jornada tenha a tripulação necessária,
...
dois problemas menores: O \textbf{problema mestre}, que é igual ao original, porém, com um conjunto reduzido de variáveis, e o \textbf{sub-problema},
