...
de pesquisa operacional~\cite{opresearch}.
...
ou preferências estipuladas pela propia tripulação. Dado um conjunto de restrições, deve-se encontrar as designações que reduzem
...
Diversas modelagens para o CSP são possíveis,~\cite{beasley1987algorithm} utilizou uma modelagem baseada em multiplos caminhos mínimos.
