...
enquanto que o \textbf{número de váriaveis é muito maior}. Um exemplo de problema com
...
o entendimento do problema a ser abordado nos próximos capitulos deste trabalho.
Discutiu-se as principais representações de problemas de programação linear e
programação linear inteira, suas principais propiedades e métodos de solução.
