...
\begin{tikzpicture}[node distance = 2cm, auto]
    ...
    \node [decision, below=6mm of redcost2, aspect = 2     , text width = 37mm] (integ)              {Solu\c{c}\~ao inteira?};
    \node [block   , minimum width=40mm, below=6mm of integ, text width = 37mm] (end)                {Retornar solu\c{c}\~ao \'otima do problema mestre};
    \node [block   , minimum width=40mm, left=15mm of integ, text width = 37mm] (bnp)                {Executar Branch and Price};
    ...
    \node [text width=1cm, below right = 2mm and -5mm of integ] (n3)    {Sim};
    \node [text width=1cm, above left  = -5mm and 6mm of integ] (s3)    {N\~ao};
