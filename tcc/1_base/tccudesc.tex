...
\titulo{Proposta de um algoritmo hibrido para a solução do Problema de Escalonamento de Tripulação}
...
\noindent Palavras-chaves: Programação linear inteira, otimização combinatória, cobertura de conjunto, agendamento de tripulação, geração de colunas.
